...
# The uuid function at least, may currently require a fork inspired by the daz-is JS fork
...
class CustomFunctions(functions.Functions):
    ...
    @functions.signature({'types': ['string','null'], 'optional': True},{'types': ['string','null'], 'optional': True})
...
# Assert that a UUID is generated (non-empty string)
assert J(data_string, 'uuid(`test`)') == "3ab8d0cd-7b76-5741-8bc9-5725650dc435"
assert J(data_string, "uuid('test', 'https://example.com')") == "e3b6d1c6-7927-5793-b875-ba63b32fe2f0"
